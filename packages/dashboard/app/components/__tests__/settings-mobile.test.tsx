...
vi.mock("../../api", () => ({
  ...
  switchAuthAccount: vi.fn(() => Promise.resolve({ success: true, account: { id: "account-1", providerId: "anthropic", label: "Account 1", credentialKind: "oauth", priority: 10, status: "active", isDefault: true, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z" } })),
  removeAuthAccount: vi.fn(() => Promise.resolve({ success: true, removed: true })),
