...
const mockSwitchAuthAccount = vi.fn();
const mockRemoveAuthAccount = vi.fn();
...
vi.mock("../../api", async (importOriginal) => {
  ...
  return createDashboardApiMock(() => importOriginal<typeof import("../../api")>(), {
    ...
    switchAuthAccount: (...args: unknown[]) => mockSwitchAuthAccount(...args),
    removeAuthAccount: (...args: unknown[]) => mockRemoveAuthAccount(...args),
...
describe("SettingsModal", () => {
  ...
  describe("Authentication provider icon wrappers", () => {
    ...
    it("hides deprecated antigravity auth providers while keeping the supported Gemini CLI account provider visible", async () => {
      mockFetchAuthStatus.mockResolvedValueOnce({
        providers: [
